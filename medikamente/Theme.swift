...
// MARK: - Medikamenten-Akzent (Chip-Muster des Guides)

// Medikamenten-Einträge nutzen ein einheitliches Avatar-Muster in Minze:
// zarte 100er-Fläche (Dark: #263B2F) + Icon/Zahl in 700 (Dark: 300).
extension Mh {
  static var avatarFlaeche: Color { minzeFlaeche }
  static var avatarText: Color { gruenText }
}

// MARK: - Typografie: Nunito (zur Laufzeit registriert, kein Info.plist nötig)

enum NunitoFont {
  // Wird nur einmal beim App-Start (medikamenteApp.init) gesetzt.
